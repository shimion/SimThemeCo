 ...
 *
 */
class CSFramework_Option_repeator extends CSFramework_Options {
  ...
  public function output() {
    ...
    echo '<div class="cs-repeator hidden">';

      echo '<h4 class="cs-repeator-title">'. $acc_title .'</h4>';
      echo '<div class="cs-repeator-content">';
      ...
      echo '<div class="cs-element cs-text-right"><a href="#" class="button cs-warning-primary cs-remove-repeator">'. __( 'Remove', 'cs-framework' ) .'</a></div>';
      echo '</div>';

    echo '</div>';

    echo '<div class="cs-repeators cs-accordion">';
      ...
      if( ! empty( $this->value ) ) {
        ...
        foreach ( $this->value as $key => $value ) {
          ...
          echo '<div class="cs-repeator">';
          echo '<h4 class="cs-repeator-title">'. $field_title .': '. $title .'</h4>';
          echo '<div class="cs-repeator-content">';
          ...
          echo '<div class="cs-element cs-text-right"><a href="#" class="button cs-warning-primary cs-remove-repeator">'. __( 'Remove SSS', 'cs-framework' ) .'</a></div>';
          echo '</div>';
          echo '</div>';
    ...
    echo '<a href="#" class="button button-primary cs-add-repeator">'. $this->field['button_title'] .'</a>';
