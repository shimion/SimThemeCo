...
require_once( _ADMIN. 'customizer/custom-controls.php' );
...
function mytheme_customizer_live_preview() {
	wp_enqueue_script( 'mytheme-themecustomizer', get_template_directory_uri() . '/inc/admin/customizer/js/customizer.js?v=' . rand(), array( 'jquery', 'customize-preview' ), false );
}
...
function mytheme_customizer_control_toggle() {
	wp_enqueue_script( 'mytheme-contextualcontrols', get_template_directory_uri() . '/inc/admin/customizer/js/customizer-contextual.js?v=' . rand(), array( 'customize-controls' ), false );
