...
class WPEditorWidget {
	...
	public function load_admin_assets() {
		...
		wp_register_script( 'wp-editor-widget-js', get_template_directory_uri(). '/inc/admin/wp-editor-widget/assets/js/admin.js', array( 'jquery' ), self::VERSION );
		wp_enqueue_script( 'wp-editor-widget-js' );

		wp_register_style( 'wp-editor-widget-css', get_template_directory_uri(). '/inc/admin/wp-editor-widget/assets/css/admin.css', array(), self::VERSION );
