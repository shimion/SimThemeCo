...
*/
add_action( 'wp_ajax_Import_Layer', 'Import_Layer' );
add_action( 'wp_ajax_nopriv_Import_Layer', 'Import_Layer' );
 ...
 */
function st_process_import_file( $file ) {
...
//echo $file;
   ...
   // print_r($data);
	...
	$st_import_results = st_import_data( $data );
//print_r($data);
}
...
function st_import_data( $data ) {
   ...
   // print_r($available_widgets);
	...
	foreach ( $data as $sidebar_id => $widgets ) {
        ...
        $sidebar_id = 'st-sidebar-'.$_REQUEST['post'];   
        echo $sidebar_id;
