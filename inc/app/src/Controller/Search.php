...
class Search extends Base
{
    ...
    public static function Form(){ 
               return     '<div class="st-search-form-wapper"><form role="search" method="get" class="form-inline my-2 my-lg-0 st-search-form" action="' . esc_url( GetConfig('global.site_url') ) . '" target="_self">
