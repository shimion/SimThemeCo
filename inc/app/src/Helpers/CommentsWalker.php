 ...
 */
use Walker_Comment as WK;
class CommentsWalker extends WK {
	/**
				...
				<div class="card-header hoverable">
					<div class="flex-center">
						...
						<a href="<?php echo get_comment_author_url(); ?>" class="media-object float-left">
							<?php echo '<figure class="d-flex mr-3 rounded-circle">'.get_avatar( $comment, $args['avatar_size'],'mm','', array('class'=>"comment_avatar rounded-circle") ).'</figure>'; ?>
